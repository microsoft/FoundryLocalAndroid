...
> **Preview:** Foundry Local for Android is under active development. APIs, capabilities, and behavior
> may change between preview releases. Review the release notes and validate your app before upgrading.
...
- [ApiExplorerAppIPC](examples/ipc/ApiExplorerAppIPC/README.md) — connection, catalog, model lifecycle, chat,
...
- [ChatAppEmbedded](examples/embedded/ChatAppEmbedded/README.md) — chat, streaming responses, and live voice input
- [AudioTranscriptionAppEmbedded](examples/embedded/AudioTranscriptionAppEmbedded/README.md) — file, streaming, and
