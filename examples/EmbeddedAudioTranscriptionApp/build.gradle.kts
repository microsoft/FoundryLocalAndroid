...
android {
    namespace = "com.microsoft.foundrylocal.embeddedaudiotranscription"
    compileSdk = androidCompileSdk

    defaultConfig {
        applicationId = "com.microsoft.foundrylocal.embeddedaudiotranscription"
...
dependencies {
    // Binary Embedded SDK AAR downloaded from GitHub Releases.
