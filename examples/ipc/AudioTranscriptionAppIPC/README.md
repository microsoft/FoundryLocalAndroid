...
1. [Foundry Local service app](https://play.google.com/store/apps/details?id=com.microsoft.foundrylocal.app) installed on your device
2. `foundry-local-ipc-sdk-<version>.aar` from the matching GitHub Release, with its published
   SHA-256 hash verified, placed in `libs/`
