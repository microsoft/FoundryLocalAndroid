...
android {
    namespace = "com.microsoft.foundrylocal.audiotranscription"
    compileSdk = androidCompileSdk

    defaultConfig {
        applicationId = "com.microsoft.foundrylocal.audiotranscription"
...
dependencies {
    // Foundry Local SDK AAR (fat AAR includes SDK + FoundryLocalIPCContract)
